...
dotnet reportgenerator "-reports:coverage.xml;../tests-unit/coverage.xml;../tests-client-integration/coverage.xml" "-targetdir:../../_coveragereport" "-assemblyfilters:-Tests.*" "-classfilters:-ICContextDesignTimeFactory;-SwaggerDefaultValues;-ApiVersioningErrorResponseProvider;-ICContextModelSnapshot;-OperationCancelledExceptionFilter"
